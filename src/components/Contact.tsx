      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Коллаборации, интервью, синхронизация — или просто хочешь написать,
              что альбом задел что-то внутри. Я читаю всё.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:kodokuna@example.com" className="text-foreground hover:text-sage transition-colors">
                  kodokuna@example.com
                </a>
              </div>
              <div>
                <p className="text-xs tracking-widest uppercase text-muted-foreground mb-2">Соцсети</p>
                <p className="text-foreground">VK · Telegram · Spotify</p>
              </div>
            </div>
          </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <button
                type="submit"
                className="group inline-flex items-center gap-3 px-8 py-4 bg-terracotta text-foreground text-sm tracking-widest uppercase hover:bg-terracotta/80 transition-all duration-500"
              >
                Отправить
                <svg
